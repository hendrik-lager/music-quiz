...
class GameState:
    ...
    def set_media_player_service(self, service: "MediaPlayerProtocol") -> None:
        """Inject the media player service (replaces HA media_player binding)."""
        self._media_player_service = service
    ...
    async def resume_game(self) -> bool:
        ...
        if previous == GamePhase.PLAYING and self.deadline:
            ...
            if remaining_ms > 0:
                ...
                from game.round_manager import (  # noqa: PLC0415
    ...
    def _detect_storefront(self) -> str | None:
        """Return None — storefront detection only needed for Apple Music."""
        return None
    ...
    def _ensure_media_player_service(self) -> None:
        """No-op: media player service is injected via set_media_player_service()."""

    def _prepare_intro_round(self, song: dict) -> bool:
        """Determine if this is an intro round. Delegates to RoundManager."""
        return self._round_manager.prepare_intro_round(song, None)
    ...
    async def configure_party_lights(
        ...
        _LOGGER.debug("Party lights not supported in standalone mode, skipping")
    ...
    async def configure_tts(
        ...
        *,
        ...
        """
        _LOGGER.debug("TTS not supported in standalone mode, skipping")
